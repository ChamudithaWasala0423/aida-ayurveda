...
export default function PostPage() {
  ...
  return (
    <>
      <Heading
        title={`${post.title} | Hasthri Boutique Chalets`}
        description="Experience the ultimate in luxury and comfort at our boutique chalets"
        keywords="luxury chalets, boutique chalets, Hasthri Boutique Chalets, wellness retreats, ayurvedic treatments, luxury accommodation"
      />
      <section>
