  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 md:py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <Card className=" border-3 border-[#FCF2EB] shadow-none">
        ...
        <div className="space-y-8">
          <div className="bg-white border-3 border-[#FCF2EB] shadow-none rounded-lg p-6 md:p-8">
          ...
          <div className="border-3 border-[#FCF2EB] shadow-none rounded-lg overflow-hidden  h-[300px] md:h-[350px]">
            <iframe
